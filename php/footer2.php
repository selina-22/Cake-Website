...
<head>
  ...
  <script type="text/javascript">
    function validate()
{
   var emailval = document.getElementById("mail");
   var regx = /^([a-zA-Z0-9\.-]+)@([a-zA-Z0-9-]+)\.([a-z]{2,20})(.[a-z]{2,8})?$/;
   if(emailval.value.trim() == ""){
          alert("Email is required.");
          return false;
        }else if(!regx.test(emailval.value)){
          ...
          <div class="flex flex-wrap md:text-left text-center order-first">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <a href="./cakes.php" class="text-gray-600 hover:text-gray-800">Cakes</a>
                </li>
                <li>
                  <a href="./pastries.php" class="text-gray-600 hover:text-gray-800">Pastries</a>
                </li>
                <li>
                  <a href="./cookies.php" class="text-gray-600 hover:text-gray-800">Biscuits</a>
                </li>
                <li>
                  <a href="./quickpeek.xml" class="text-gray-600 hover:text-gray-800">Quick Peek</a>
                </li>
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <a href="./wedcake.php" class="text-gray-600 hover:text-gray-800">Wedding day cakes</a>
                </li>
                <li>
                  <a href="./seasonalcake.php" class="text-gray-600 hover:text-gray-800">Seasonal cakes</a>
                </li>
...
<!--_____________________________________________******VALIDATION******___________________________________________________-->
                ...
                <input class="w-40 sm:w-auto bg-gray-100 rounded xl:mr-4 lg:mr-0 sm:mr-4 mr-2 border border-gray-400 focus:outline-none focus:border-indigo-500 text-base py-2 px-4 form-control" placeholder="Email" type="text" name='email' id='mail' autocomplete="off">
                
                <button name="submits" class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" type="submit">SUBSCRIBE</button>
              </form>
